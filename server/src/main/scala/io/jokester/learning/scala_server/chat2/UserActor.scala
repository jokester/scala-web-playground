...
import akka.actor._
import io.jokester.learning.scala_server.util.ActorLoggingLifecycle
...
class UserActor(uuid: UUID) extends Actor with ActorLogging with ActorLoggingLifecycle {
